...
export type Extraction = { facts: Record<Field, Fact[]>; lines: { description: Fact; quantity: Fact; unit: Fact }[] };
...
export const DecisionSchema = z.object({
  ...
  actor: z.string().trim().min(1), reason: z.string(), draft: DraftSchema
}).strict();
